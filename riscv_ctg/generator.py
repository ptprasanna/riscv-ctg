            ...
            if self.opcode[0] == 'f' and 'fence' not in self.opcode:
                ...
                if self.opcode not in ['fsw','flw']:
                    if instr['val_offset'] == '0' and k == 0:
                        ...
                        if instr['inst'] in three_operand_hinstructions:
                            code.append("addi "+vreg+","+vreg+","+str(2034))    # Offset being incremented by 2 for each load/store
                        elif instr['inst'] in three_operand_dinstructions + three_operand_finstructions:
